        ...
        stage('Docker Run') {
            steps {
                ...
                sshagent(credentials: ['ssh']) {
                    ...
                    sh "ssh -o StrictHostKeyChecking=no kimhwan@kimhwan.kr 'docker run -d --restart always --name ${APP_NAME} -v /home/kimhwan/hwans-api-server-data:/var/attachments -p 1200:8080 --network hwans-api-server-net ${IMAGE_NAME}'"
